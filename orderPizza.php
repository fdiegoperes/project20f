  ...
  if(isset($_POST['addPizzaToOrder'])) { 
    ...
    if(isset($_SESSION['pizza_order'])) {
      ...
      if ($customerExist != "") {
        ...
        echo "<script>window.open('orderSummary.php','_self')</script>";
      }
    }
  }
?>
...
<div class="main-content" >
  ...
  <form method="post">
    ...
    <p>
      ...
      <input type="checkbox" id="potato" name="toppings[]" value="potato" <?php if (checkedToppings("potato")) echo "checked"?>>
      <label for="toppings">Potato</label>
      <input type="checkbox" id="sausage" name="toppings[]" value="sausage" <?php if (checkedToppings("sausage")) echo "checked"?>>
      <label for="toppings">Sausage</label>
      <input type="checkbox" id="bacon" name="toppings[]" value="bacon" <?php if (checkedToppings("bacon")) echo "checked"?>>
      <label for="toppings">Bacon</label>
      <input type="checkbox" id="mushroom" name="toppings[]" value="mushroom" <?php if (checkedToppings("mushroom")) echo "checked"?>>
      <label for="toppings">Mushroom</label>
      <input type="checkbox" id="black-olives" name="toppings[]" value="black-olives" <?php if (checkedToppings("black-olives")) echo "checked"?>>
      <label for="toppings">Black olives</label>
      <input type="checkbox" id="radicchio" name="toppings[]" value="radicchio" <?php if (checkedToppings("radicchio")) echo "checked";?>>
      <label for="toppings">Radicchio</label>
      <input type="checkbox" id="anchovies" name="toppings[]" value="anchovies" <?php if (checkedToppings("anchovies")) echo "checked";?>>
      <label for="toppings">Anchovies</label>
      <input type="checkbox" id="eggplant" name="toppings[]" value="eggplant" <?php if (checkedToppings("eggplant")) echo "checked";?>>
      <label for="toppings">Eggplant</label>
      <input type="checkbox" id="pepperoni" name="toppings[]" value="pepperoni" <?php if (checkedToppings("pepperoni")) echo "checked";?>>
      <label for="toppings">Pepperoni</label>
      <input type="checkbox" id="ham" name="toppings[]" value="ham" <?php if (checkedToppings("ham")) echo "checked";?>>
